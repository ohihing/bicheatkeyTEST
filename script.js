...
const results = {
    ...
    "BDE": { img: "assets/a007.png", title: "단호박 스펀지", desc: "절대 호구 안 당함! 웃으며 내 몫 다 챙기는 실속파\n\n스트레스받는 상황에서도 유연하게 대처하며 절대 호구 잡히지 않는 당신! '아유~ 부장님 그건 좀 힘들 것 같아요^o^' 라며 기분 나쁘지 않게 내 선을 완벽하게 지켜내는 타입입니다.\n\n상대방의 감정은 적당히 스펀지처럼 흡수해 주면서도, 부당한 요구는 단호박처럼 잘라내는 스킬이 예술이네요. 당신은 감정 소모는 최소화하고 챙길 건 다 챙기는 진정한 의미의 스마트한 직장인입니다!", solution: "중요한 것은 선을 넘는 질문에 반드시 성실하게 답해야 한다는 압박에서 벗나는 것이다. 대화에서 경계를 지키는 것은 까다로운 태도가 아니다. 자신을 지키는 방식이다. (p.87)" },
